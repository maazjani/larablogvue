<template>
    <section class="cta-section theme-bg-light py-5">
		    <div class="container text-center single-col-max-width">
			    <h2 class="heading">MaazBlog - This blog is a part of my learning curve</h2>
			    <div class="intro">Welcome to my blog. Subscribe and get my latest blog post in your inbox.</div>
			    <div class="single-form-max-width pt-3 mx-auto">
				    <form class="signup-form row g-2 g-lg-2 align-items-center">
	                    <div class="col-12 col-md-9">
	                        <label class="sr-only" for="semail">Your email</label>
	                        <input type="text" id="semail" name="semail1" class="form-control me-md-1 semail" placeholder="Search Blog">
	                    </div>
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
		    <div class="container single-col-max-width">
			    <div class="item mb-5">
				    <div class="row g-3 g-xl-0">
					    <div class="col-2 col-xl-3">
					        <img class="img-fluid post-thumb " src="../images/blog/blog-post-thumb-1.jpg" alt="image">
					    </div>
					    <div class="col">
			    ...
			    <div class="item mb-5">
				    <div class="row g-3 g-xl-0">
					    <div class="col-2 col-xl-3">
					        <img class="img-fluid post-thumb " src="../images/blog/blog-post-thumb-2.jpg" alt="image">
					    </div>
					    <div class="col">
			    ...
			    <div class="item mb-5">
				    <div class="row g-3 g-xl-0">
					    <div class="col-2 col-xl-3">
					        <img class="img-fluid post-thumb" src="../images/blog/blog-post-thumb-3.jpg" alt="image">
					    </div>
					    <div class="col">
			    ...
			    <div class="item mb-5">
				    <div class="row g-3 g-xl-0">
					    <div class="col-2 col-xl-3">
					        <img class="img-fluid post-thumb" src="../images/blog/blog-post-thumb-4.jpg" alt="image">
					    </div>
					    <div class="col">
			    ...
			    <div class="item mb-5">
				    <div class="row g-3 g-xl-0">
					    <div class="col-2 col-xl-3">
					        <img class="img-fluid post-thumb" src="../images/blog/blog-post-thumb-5.jpg" alt="image">
					    </div>
					    <div class="col">
			    ...
			    <div class="item">
				    <div class="row g-3 g-xl-0">
					    <div class="col-2 col-xl-3">
					        <img class="img-fluid post-thumb" src="../images/blog/blog-post-thumb-6.jpg" alt="image">
					    </div>
					    <div class="col">
